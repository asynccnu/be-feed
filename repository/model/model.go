...
type FeedEventIndex struct {
	StudentId string `gorm:"column:student_id;type:varchar(255);not null"` // 学生 ID，唯一
	FeedID    int64  `gorm:"column:feed_id;type:BIGINT;not null"`
...
type StudentIdAndToken struct {
	StudentId string
	Tokens    []string
}

func (Token) TableName() string {
	return "feed_user_token" // 将这里替换为你的实际表名
}

func (UserFeedConfig) TableName() string {
	return "user_feed_configs" // 将这里替换为你的实际表名
}

func (FeedEventIndex) TableName() string {
	return "feed_event_index"
}
